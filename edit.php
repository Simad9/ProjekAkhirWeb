    ...
    <div class=" kanan col-9 bg-putih p-2 ">
      ...
      <div class="profile d-flex justify-content-between kotakv2 shadow ">
        <div class="d-flex justify-content-center align-items-center">
          <h3 class="m-0">Selamat Datang, Wijdan</h3>
        </div>
      ...
      <div class="wadah kotakv3 shadow">
        ...
        <div class="resep d-flex flex-wrap justify-content-start gap-2 mx-2">
          <div class="w-75 d-flex flex-column align-items-start">
            ...
            <div class="d-flex justify-content-start align-items-center gap-2">
              ...
              <div class="w-40 d-flex flex-column justify-content-start align-items-start gap-1">
                ...
                <input id="file-upload" type="file" accept="image/*" onchange="loadFile(event)" class="w-100" />
              </div>
            </div>
          </div>
          ...
          <div class="w-100 ">
            ...
            <input type="text" class="form-control border-black" placeholder="Nama Lengkap">
          </div>
          <div class="w-100 ">
            <h4 class="mt-2">Username : </h4>
            <input type="text" class="form-control border-black" placeholder="Username">
          </div>
          <div class="w-100 ">
            <h4 class="mt-2">Email : </h4>
            <input type="text" class="form-control border-black" placeholder="Email">
          </div>
          <div class="w-100 ">
            <h4 class="mt-2">Headline : </h4>
            <input type="text" class="form-control border-black" placeholder="Contoh : Mahasiswa yang suka memasak">
          </div>
