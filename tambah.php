...
<html lang="en">
  ...
  <body>
    <section class="d-flex h-100dvh">
      <!-- NAVBAR -->
      <div
        class="kiri col-3 bg-grey d-flex flex-column justify-content-center position-fixed h-100"
      >
        ...
        <div class="p-2 mt-2 d-flex flex-column justify-content-between h-100">
          <div class="tempat-nav-item d-flex flex-column gap-1">
            <a class="text-decoration-none" href="dashboard.php">
              <div
                class="d-flex justify-content-start align-items-end gap-2 item-navigation px-3 cursor-pointe"
              >
            ...
            <a class="text-decoration-none" href="tambah.php">
              <div
                class="d-flex justify-content-start align-items-end gap-2 item-navigation active px-3 cursor-pointer"
              >
          ...
          <a class="text-decoration-none" href="login.php">
            <div
              class="d-flex justify-content-center align-items-end gap-2 item-navigation"
            >
      ...
      <div class="kanan col-9 bg-putih p-2">
        ...
        <div class="profile d-flex justify-content-between kotakv2 shadow">
          ...
          <div
            class="akun d-flex gap-2 align-items-center justify-content-center me-2"
          >
            <a class="text-decoration-none text-hitam" href="tambah.php"
              ><i class="bi bi-plus-lg fs-3 cursor-pointer"></i
            ></a>
        ...
        <div class="wadah kotakv3 shadow">
          ...
          <form action="./php/add_proses.php" method="post" enctype="multipart/form-data">
            <div
              class="resep d-flex flex-wrap justify-content-start gap-2 mx-2"
            >
              <div class="w-75 d-flex flex-column align-items-start">
                ...
                <img
                  src=""
                  id="imageView"
                  class="bg-secondary gambar-resep-prev mt-2 rounded-4"
                />
              </div>
              ...
              <div class="w-100">
                <h4 class="mt-2">Tanggal Pembuatan :</h4>
